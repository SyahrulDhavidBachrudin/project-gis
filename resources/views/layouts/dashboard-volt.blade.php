...
<body>
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <li class="nav-item">
                    <a href="../../home" class="nav-link d-flex align-items-center">
                        ...
                        <span class="mt-1 ms-1 sidebar-text">GIS GHPR</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="multi-level collapse " role="list" id="submenu-app" aria-expanded="false">
                        <ul class="flex-column nav">
                            ...
                            <li class="nav-item {{ Request::is('getCoordinate') ? 'active' : '' }}">
    ...
    <main class="content">
        ...
        <footer class="bg-white rounded shadow p-5 mb-4 mt-4 ">
            <div class="row">
                <div class="">
                    <p class="mb-4 text-center ">© 2023 - <span class="current-year"></span> <a
                            class="text-primary fw-normal " href= "https://dinkes.semarangkota.go.id/"
                            target="_blank">Dinas Kesehatan Kota Semarang</a></p>
                </div>
